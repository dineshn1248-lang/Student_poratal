...
export default function HODAttendance() {
  ...
  const currentStudentData = allStudentData[activeTab] || [];
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(6, 1fr)', gap: '16px', marginBottom: '24px' }}>
        <div style={{ background: '#ffffff', borderRadius: '12px', padding: '20px', display: 'flex', alignItems: 'center', gap: '16px', border: '1px solid #e2e8f0', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
          ...
          <div>
            ...
            <div style={{ fontSize: '20px', color: '#0f172a', fontWeight: '900' }}>42</div>
          </div>
        </div>
        ...
        <div style={{ background: '#ffffff', borderRadius: '12px', padding: '20px', display: 'flex', alignItems: 'center', gap: '16px', border: '1px solid #e2e8f0', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', alignItems: 'baseline', gap: '6px' }}>
              <div style={{ fontSize: '20px', color: '#0f172a', fontWeight: '900' }}>35</div>
              <div style={{ fontSize: '14px', color: '#64748b', fontWeight: '600' }}>(83.33%)</div>
            </div>
          </div>
        </div>
        ...
        <div style={{ background: '#ffffff', borderRadius: '12px', padding: '20px', display: 'flex', alignItems: 'center', gap: '16px', border: '1px solid #e2e8f0', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', alignItems: 'baseline', gap: '6px' }}>
              <div style={{ fontSize: '20px', color: '#0f172a', fontWeight: '900' }}>5</div>
              <div style={{ fontSize: '14px', color: '#64748b', fontWeight: '600' }}>(11.90%)</div>
            </div>
          </div>
        </div>
        ...
        <div style={{ background: '#ffffff', borderRadius: '12px', padding: '20px', display: 'flex', alignItems: 'center', gap: '16px', border: '1px solid #e2e8f0', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', alignItems: 'baseline', gap: '6px' }}>
              <div style={{ fontSize: '20px', color: '#0f172a', fontWeight: '900' }}>2</div>
              <div style={{ fontSize: '14px', color: '#64748b', fontWeight: '600' }}>(4.76%)</div>
            </div>
          </div>
        </div>
