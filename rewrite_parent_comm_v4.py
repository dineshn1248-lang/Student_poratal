...
import { FaWhatsapp, FaSms, FaEnvelope, FaCheckCircle, FaSpinner, FaExclamationTriangle, FaUsers, FaPaperPlane, FaTimesCircle, FaBroadcastTower, FaRedoAlt, FaStethoscope, FaCode, FaAt, FaInfoCircle, FaChartPie } from 'react-icons/fa';
import './HOD.css';
...
export default function HODParentCommunication() {
    ...
    return (
        <div className="hod-page-content">
            {/* Demo Mode Banner */}
            <div style={{ background: '#1e293b', border: '1px solid #334155', borderRadius: '12px', padding: '16px 24px', marginBottom: '24px', display: 'flex', alignItems: 'center', gap: '20px', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06)' }}>
                ...
                <div style={{ display: 'flex', gap: '12px' }}>
                    <div style={{ background: 'rgba(244,63,94,0.1)', border: '1px solid rgba(244,63,94,0.3)', padding: '6px 12px', borderRadius: '8px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                        <FaEnvelope style={{ color: '#f43f5e' }} />
                        <span style={{ color: '#f1f5f9', fontSize: '12px', fontWeight: '700' }}>Email: <span style={{ color: '#f43f5e' }}>Active</span></span>
                    </div>
                    <div style={{ background: 'rgba(34,197,94,0.1)', border: '1px solid rgba(34,197,94,0.3)', padding: '6px 12px', borderRadius: '8px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                        ...
                        <span style={{ color: '#f1f5f9', fontSize: '12px', fontWeight: '700' }}>WhatsApp: <span style={{ color: '#fbbf24' }}>Sandbox</span></span>
                    </div>
                    <div style={{ background: 'rgba(59,130,246,0.1)', border: '1px solid rgba(59,130,246,0.3)', padding: '6px 12px', borderRadius: '8px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                        <FaSms style={{ color: '#3b82f6' }} />
                        <span style={{ color: '#f1f5f9', fontSize: '12px', fontWeight: '700' }}>SMS: <span style={{ color: '#fbbf24' }}>Sandbox</span></span>
                    </div>
                </div>
            </div>
...
print("Overwrote HODParentCommunication.jsx for Demo Mode configuration successfully!")
