...
with app.app_context():
    student = Student.query.filter_by(register_no=lakshmi_reg).first()
    if not student:
        print(f"Student {lakshmi_reg} not found!")
        sys.exit(1)
